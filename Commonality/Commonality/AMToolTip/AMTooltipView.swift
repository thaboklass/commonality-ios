...
public class AMTooltipViewOptions{
    ...
    public init(
        ...
        textColor:UIColor = UIColor(red: 192.0/255.0, green: 30.0/255.0, blue: 201.0/255.0, alpha: 1.0), //UIColor.white,
        textWidth:CGFloat = 270,
        font:UIFont = UIFont(name: "Avenir", size: 15)!, //UIFont.systemFont(ofSize: 14),
        textAlignment:NSTextAlignment = .natural,
        textBoxBackgroundColor:UIColor = UIColor.white, //UIColor(red: 41.0/255.0, green: 169.0/255.0, blue: 158.0/255.0, alpha: 1.0), //UIColor.white, 41, 169, 158
        textBoxCornerRadius:CGFloat = 12,
        textBoxBorderColor:UIColor = UIColor(red: 192.0/255.0, green: 30.0/255.0, blue: 201.0/255.0, alpha: 1.0), //UIColor.clear,
        textBoxBorderWidth:CGFloat = 2,
        ...
        dotColor:UIColor = UIColor.white, //UIColor(red: 41.0/255.0, green: 169.0/255.0, blue: 158.0/255.0, alpha: 1.0), //UIColor.lightGray,
        dotSize:CGFloat = 13,
        dotBorderWidth:CGFloat = 2,
        dotBorderColor:UIColor = UIColor(red: 192.0/255.0, green: 30.0/255.0, blue: 201.0/255.0, alpha: 1.0), //UIColor.white,
...
open class AMTooltipView: UIView {
    ...
    fileprivate func loadNib() {
        Bundle.main.loadNibNamed("AMTooltipView", owner: self, options: nil)
    ...
    func show(){
        ...
        let portionOne = (options.textWidth + padding*2)/2
       
            let spaceFromLeftSide = cutOutViewX.constant + cutOutViewWidth.constant/2 - portionOne
        ...
        let portionTwo = (options.textWidth + padding*2)/2
            
            let spaceFromRightSide = cutOutViewX.constant + cutOutViewWidth.constant/2 + portionTwo
